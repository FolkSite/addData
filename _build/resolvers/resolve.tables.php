...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('adddata_core_path', null,
                    $modx->getOption('core_path') . 'components/adddata/') . 'model/';
            $modx->addPackage('adddata', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/adddata/model/schema/adddata.mysql.schema.xml';
